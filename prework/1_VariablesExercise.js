...
let dreamDestination = "Singapore";
...
// num2 but not num1?
// the difference between the rules for num1 & num2 is that num1 is exclusive of the values 1 & 10, while num2 is inclusive of the values 1 & 10
// valid values num1 = 2-9, valid values of num2 = 1-10
...
// I used the console and I also used replit to check my answers once I answered all the questions.
